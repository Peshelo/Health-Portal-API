...
import tech.stabnashiamunashe.DoctorPatientPortal.Payments.PayPal.PaymentInformation.PaymentInformation;
import tech.stabnashiamunashe.DoctorPatientPortal.Payments.PayPal.PaymentInformation.PaymentInformationService;
...
public class PayPalController {
    ...
    public ResponseEntity<?> completePayment(@RequestParam("paymentId") String paymentId,
